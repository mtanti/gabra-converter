...
from gabra_converter.converters.wordforms.exporters.wordforms_exporter import WordformsExporter
...
#########################################
class CSVWordformsExporter(WordformsExporter):
    '''
    A concrete WordformsExporter class that exports wordforms to comma separated files.
    '''
    ...
    def add_row(
        ...
        '''
        super().add_row(lexemes_id_map, row)
