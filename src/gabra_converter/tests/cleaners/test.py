...
class TestLexemes(unittest.TestCase):
    ...
    def test_new_lines(self) -> None:
        ...
        with open(
            os.path.join(
                gabra_converter.path, 'tests', 'cleaners', 'test_set_lexemes_new_lines.json'
            ),
            'r', encoding='utf-8'
        ) as f:
    ...
    #########################################
    def test_lemma_spaces(self) -> None:
        '''
        ...
        with open(
            os.path.join(
                gabra_converter.path, 'tests', 'cleaners', 'test_set_lexemes_lemma_spaces.json'
            ),
            'r', encoding='utf-8'
        ) as f:
            test_set = json.load(f)
    ...
    #########################################
    def test_lemma_capitals(self) -> None:
        '''
        ...
        with open(
            os.path.join(
                gabra_converter.path, 'tests', 'cleaners', 'test_set_lexemes_lemma_capitals.json'
            ),
            'r', encoding='utf-8'
        ) as f:
            test_set = json.load(f)
    ...
    #########################################
    def test_lemma_nonmaltese(self) -> None:
        '''
        ...
        with open(
            os.path.join(
                gabra_converter.path, 'tests', 'cleaners', 'test_set_lexemes_lemma_nonmaltese.json'
            ),
            'r', encoding='utf-8'
        ) as f:
            test_set = json.load(f)
...
class TestWordforms(unittest.TestCase):
    ...
    #########################################
    def test_missing_lexeme(self) -> None:
        '''
        ...
        with open(
            os.path.join(
                gabra_converter.path, 'tests', 'cleaners', 'test_set_wordforms_missing_lexeme.json'
            ),
            'r', encoding='utf-8'
        ) as f:
            test_set = json.load(f)
    ...
    #########################################
    def test_surfaceform_capitals(self) -> None:
        '''
    ...
    #########################################
    def test_surfaceform_spaces(self) -> None:
        '''
    ...
    #########################################
    def test_surfaceform_nonmaltese(self) -> None:
        '''
