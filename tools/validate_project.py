...
def main(
    ...
    check_docstrings_dir(os.path.abspath(os.path.join(gabra_converter.path, '..', '..', 'tools')))
    check_docstrings_dir(os.path.abspath(os.path.join(gabra_converter.path, '..', '..', 'tests')))
    check_docstrings_dir(gabra_converter.path)
